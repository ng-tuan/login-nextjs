  ...
  return (
    <Link href="/category/[id]" as={`/category/${item.id}`}>
      <div className="container">
        {/* <div className="bg-white border border-gray-200 rounded-md mt-14 mb-14 p-6 transition-transform group hover:shadow-lg">
        ...
        <div className="group pb-14 relative overflow-hidden">
          <div className="group-hover:translate-y-0 transition-all duration-700 translate-y-full top-0 right-0 bottom-24 left-0 absolute bg-gradient-to-b from-transparent to-orange-600 z-10" />
          <img
          ...
          <div className="bg-orange-600 absolute z-10 bottom-0 left-0 w-full h-24 flex flex-col justify-center items-center">
            ...
            <div className="group-hover:hidden transition-all duration-1000 w-4 absolute overflow-hidden inline-block right-0 -top-6">
              <div className="h-6  bg-orange-900 -rotate-45 transform origin-bottom-right" />
            </div>
